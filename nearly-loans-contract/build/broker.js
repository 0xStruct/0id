...
BigInt(0);
JSON.stringify({});
let Broker = (_dec = NearBindgen({}), _dec2 = call({}), _dec3 = call({}), _dec4 = call({}), _dec5 = call({
  payableFunction: true
}), _dec6 = call({}), _dec7 = call({}), _dec8 = call({
  payableFunction: true
}), _dec9 = call({}), _dec10 = view(), _dec11 = view(), _dec(_class = (_class2 = class Broker {
  constructor() {
    this.loans_counter = 0;
    this.loans_map = new LookupMap("loans");
    this.loans_by_borrowers = new LookupMap("loans-by-borrowers");
  ...
  nft_on_transfer({
    ...
    const loan = {
      ...
      collateral_asset_contract: predecessorAccountId(),
      date_requested: blockTimestamp(),
    ...
    if (loans_by_borrower == null) loans_by_borrower = new Set();
  ...
  edit_request_loan({
    ...
    assert(loan.borrower === predecessorAccountId(), "only the borrower can request");
  ...
  cancel_request_loan({
    ...
    let loan = this.loans_map.get(loan_id);
    assert(loan.loan_status === "DRAFT" || "REQUESTED", "loan_status must be of DRAFT or REQUESTED");
    assert(loan.borrower === predecessorAccountId(), "only the borrower can cancel");
    this.loans_map.remove(loan_id);
    let loans_by_borrower = this.loans_by_borrowers.get(loan.borrower);
    loans_by_borrower?.delete(loan.id);
    this.loans_by_borrowers.set(loan.borrower, loans_by_borrower || new Set());

    // send collateral back to borrower
    return NearPromise.new(loan.collateral_asset_contract).functionCall("nft_transfer", JSON.stringify({
      receiver_id: loan.borrower,
      token_id: loan.collateral_asset_id
    }), BigInt(1), TWENTY_TGAS).asReturn();
  }
  offer_loan({
    loan_id
  }) {
    ...
    assert(loan.loan_amount === attachedDeposit(), "incorrect attached deposit for loan request");
    loan.lender = predecessorAccountId();
    loan.date_offered = blockTimestamp();
    loan.loan_amount = attachedDeposit();
  ...
  cancel_offer_loan({
    ...
    assert(loan.lender === predecessorAccountId(), "only the lender can cancel the offer");
    ...
    return NearPromise.new(loan.lender).transfer(loan.loan_amount).asReturn();
  }
  start_loan({
    loan_id
  }) {
    ...
    assert(loan.borrower === predecessorAccountId(), "loan can only be started by the borrower");
    loan.date_started = blockTimestamp();
    loan.loan_status = "STARTED";
    this.loans_map.set(loan_id, loan);

    // send $NEAR to borrower
    return NearPromise.new(loan.borrower).transfer(loan.loan_amount).asReturn();
  }
  ...
  redeem_loan({
    ...
    assert(loan.date_started + BigInt(loan.loan_duration * 24 * 60 * 60 * 1000000000) >= blockTimestamp(), "redemption period is over");
    assert(loan.borrower === predecessorAccountId(), "loan can only be redeemed by the borrower");
    ...
    assert(attachedDeposit() === payback, "payback must be loan + interest");
    loan.loan_interest = BigInt(interest);
    loan.date_redeemed = blockTimestamp();
  ...
  liquidate_loan({
    ...
    assert(loan.date_started + BigInt(loan.loan_duration * 24 * 60 * 60 * 1000000000) < blockTimestamp(), "redemption period is not over yet");
    assert(loan.lender === predecessorAccountId(), "loan can only be liquidated by the lender");
    loan.date_liquidated = blockTimestamp();
    loan.loan_status = "LIQUIDATED";
    this.loans_map.set(loan_id, loan);

    // send collateral back to lender as borrower has defaulted
    return NearPromise.new(loan.collateral_asset_contract).functionCall("nft_transfer", JSON.stringify({
      receiver_id: loan.lender,
      token_id: loan.collateral_asset_id
    }), BigInt(1), TWENTY_TGAS).asReturn();
  }
  get_loans() {
...
}, _applyDecoratedDescriptor(_class2.prototype, "nft_on_transfer", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "nft_on_transfer"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "edit_request_loan", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "edit_request_loan"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "cancel_request_loan", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "cancel_request_loan"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "offer_loan", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "offer_loan"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "cancel_offer_loan", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "cancel_offer_loan"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "start_loan", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "start_loan"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "redeem_loan", [_dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "redeem_loan"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "liquidate_loan", [_dec9], Object.getOwnPropertyDescriptor(_class2.prototype, "liquidate_loan"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_loans", [_dec10], Object.getOwnPropertyDescriptor(_class2.prototype, "get_loans"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_loan", [_dec11], Object.getOwnPropertyDescriptor(_class2.prototype, "get_loan"), _class2.prototype), _class2)) || _class);
/*
...
// }
function get_loan() {
  const _state = Broker._getState();
  if (!_state && Broker._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  const _contract = Broker._create();
  if (_state) {
    Broker._reconstruct(_contract, _state);
  }
  const _args = Broker._getArgs();
  const _result = _contract.get_loan(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Broker._serialize(_result, true));
}
function get_loans() {
  const _state = Broker._getState();
  if (!_state && Broker._requireInit()) {
  ...
  const _args = Broker._getArgs();
  const _result = _contract.get_loans(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Broker._serialize(_result, true));
}
function liquidate_loan() {
  ...
  const _args = Broker._getArgs();
  const _result = _contract.liquidate_loan(_args);
  Broker._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Broker._serialize(_result, true));
}
function redeem_loan() {
  const _state = Broker._getState();
  if (!_state && Broker._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = Broker._getArgs();
  const _result = _contract.redeem_loan(_args);
  Broker._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Broker._serialize(_result, true));
}
function start_loan() {
  ...
  const _args = Broker._getArgs();
  const _result = _contract.start_loan(_args);
  Broker._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Broker._serialize(_result, true));
}
function cancel_offer_loan() {
  const _state = Broker._getState();
  if (!_state && Broker._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = Broker._getArgs();
  const _result = _contract.cancel_offer_loan(_args);
  Broker._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Broker._serialize(_result, true));
}
function offer_loan() {
  ...
  const _args = Broker._getArgs();
  const _result = _contract.offer_loan(_args);
  Broker._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Broker._serialize(_result, true));
}
function cancel_request_loan() {
  const _state = Broker._getState();
  if (!_state && Broker._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = Broker._getArgs();
  const _result = _contract.cancel_request_loan(_args);
  Broker._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Broker._serialize(_result, true));
}
function edit_request_loan() {
  const _state = Broker._getState();
  if (!_state && Broker._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = Broker._getArgs();
  const _result = _contract.edit_request_loan(_args);
  Broker._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Broker._serialize(_result, true));
}
function nft_on_transfer() {
  ...
  const _args = Broker._getArgs();
  const _result = _contract.nft_on_transfer(_args);
  Broker._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Broker._serialize(_result, true));
}

export { cancel_offer_loan, cancel_request_loan, edit_request_loan, get_loan, get_loans, liquidate_loan, nft_on_transfer, offer_loan, redeem_loan, start_loan };
